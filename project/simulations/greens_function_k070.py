"""Green's function simulation at k_eff ≈ 0.70 (R = 17.700 cm).

Mirrors project/simulations/greens_function.py with the calibrated radius from
KEFF_CONFIGS[0.70]. Run with: python -m project.simulations.greens_function_k070
"""
import numpy as np
import openmc
...
settings["source"] = openmc.IndependentSource(
    space=openmc.stats.SphericalIndependent(
        r=openmc.stats.PowerLaw(0, RADIUS, 2),
