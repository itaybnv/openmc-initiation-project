"""Green's function simulation at k_eff ≈ 0.40 (R = 11.400 cm).

Mirrors project/simulations/greens_function.py with the calibrated radius from
KEFF_CONFIGS[0.40]. Run with: python -m project.simulations.greens_function_k040
"""
import numpy as np
import openmc
